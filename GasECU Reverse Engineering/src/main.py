...
def process_data(data):
    responses = {
        ...
        b"\xC0\xD8\xD8\x70": b"\xD8\x03\x0F\x80\x0A\x72\xDB\x24\x1E\x07\xCD\x00\x82\x01\xF9\x01\x00\x1C\x01\xF4\x01"
                             b"\xF4\x04\x39\x96\x03\x00",

        b"\xC0\x35\x00\xF5": b"\x35\xC8\x8F\x5C\x28\xE0",
        ...
        b"\xC0\x0B\x0B\xD6": b"\x0B\x79\x69\x93\x9B\x6B\x17\x65\xBA\xA2\x49\x82\x46\x02\x49\x02\x48\x03\x0C\x03\x08"
                      b"\x03\x06\x03\x04\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x17\x72\x00\x00\xFF\x01\x88\x00\x02\x11",
        ...
        b"\xC0\x07\x35\xFC": b"\x07\x35\x3C\x48",
        b"\xC0\x10\x10\xE0": b"\x10\x04\x19\x00\xF3\x03\xA7\x07\x4E\x0A\xF5\x0E\x9C\x10\x00\x10\x00\x10\x00\x10\x00\xD8",
        b"\xC0\x13\x13\xE6": b"\x13\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xE3",

        b"\xC0\x95\x00\x55": b"\x95\x00\x00\x00\xF3\x01\xB6\x03\x1A\x01\xF9\x03\x1B\x02\xD9\x04\x8B\x04\x4F\x06"
                      b"\x13\x05\x8D\x07\x1F\x06\xA6\x08\x06\x08\x09\x09\x12\x0A\x98\x0B\x76\x12\x43\x11\x6C\xAD",

        b"\xC0\x95\x01\x56": b"\x95\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF"
                      b"\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\x3D",

        b"\xC0\x07\x1E\xE5": b"\x07\x1E\x68\x5D",

        b"\xC0\xD4\x00\x94": b"\xD4\x00\x00\x00\xF3\x01\xB6\x03\x1A\x01\xF9\x03\x1B\x02\xD9\x04\x8B\x04\x4F\x06"
                             b"\x13\x05\x8D\x07\x1F\x06\xA6\x08\x06\x08\x09\x09\x12\x0A\x98\x0B\x76\x12\x43\x11\x6C\xEC",

        b"\xC0\xD4\x01\x95": b"\xD4\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF"
                             b"\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\x7C",


        b"\xC0\x12\x01\xD3": b"\x12\x01\x04\x19\x00",
        b"\xC0\x12\x02\xD4": b"\x12\x02\x00\xF3\xD7",
        b"\xC0\x12\x0B\xDD": b"\x12\x0B\x04\x00\xF1",
        b"\xC0\x12\x0C\xDE": b"\x12\x0C\x00\x00\xEE",
        b"\xC0\x12\x0D\xDF": b"\x12\x0D\x00\x00\xEF",

        b"\xC0\xC0\x00\x80": b"\xC0\x01\xF9\x02\xEC\x02\xFF\x04\xE5\x62",
        b"\xC0\xD0\x00\x90": b"\xD0\x66\x50\x3C\x2F\x21\x17\x0F\x09\x00\xFA\xF6\xF4\xF0\xEE\xEA\xE8\xE6\xE4\xE1\xE0\x30",
        b"\xC0\xD2\x00\x92": b"\xD2\xF2\xF4\xF6\xF7\xF8\xFB\xFC\xFE\xFF\x00\x01\x01\x01\x02\x02\x02\x03\x03\x04\x05\x79",

        b"\xC0\xDB\x00\x9B": b"\xDB\x00\x00\x00\x00\x00\x00\x01\x02\x03\x04\x05\x08\x0A\x0B\x0C\x0D\x0E\x0F\x10\x11\x2E",
        b"\xC0\x97\x00\x57": b"\x97\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x67",

        b"\xC0\x60\xA5\xC5": b"\x60\x0A\x14\x1E\x28\x32\x3C\x46\x50\x5A\x64\x01\xF4\x03\xE8\x05\xDC\x07\xD0\x09\xC4"
                             b"\x0B\xB8\x0D\xAC\x0F\xA0\x11\x94\x13\x88\x26",
